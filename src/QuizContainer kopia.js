    ...
    this.myQuestions.forEach(
      (currentQuestion, questionNumber) => {
        ...
        for (var letter in currentQuestion.answers) {
          ...
          // ...add an HTML button for each letter a b c d
          answers.push(
            `<button value="${letter}">${currentQuestion.answers[letter]}</button>
            `
          );
        }
...
render(){
  ...
  return(
    <div>
      <div ref="quiz"></div>
      <button ref="answer" onClick = {this.showResults}></button>
      <button ref="next" onClick = {this.showResults}>Next</button>
